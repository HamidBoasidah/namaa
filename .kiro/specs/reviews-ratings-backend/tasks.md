...
- [ ] 1. Set up Review Model and update related models
  ...
  - [x] 1.2 Add Review relationship to Booking model
    - Add hasOne relationship: review()
    - _Requirements: 9.4_

  - [x] 1.3 Add Reviews relationship to Consultant model
    - Add hasMany relationship: reviews()
    - _Requirements: 9.5_

  - [x] 1.4 Add Reviews relationship to User model
    - Add hasMany relationship: clientReviews()
    - _Requirements: 9.6_

- [ ] 2. Implement ReviewRepository
  - [x] 2.1 Create ReviewRepository class
...
- [x] 4. Implement ReviewService
  - [x] 4.1 Create ReviewService class
  ...
  - [x] 4.2 Write property test for One Review Per Booking Invariant
  ...
  - [x] 4.3 Write property test for Data Consistency
  ...
  - [x] 4.4 Write property test for Completed Booking Prerequisite
  ...
  - [x] 4.5 Write property test for Rating Range Invariant
...
- [x] 6. Implement Form Requests
  - [x] 6.1 Create StoreReviewRequest
...
- [x] 7. Implement ReviewPolicy
  ...
  - [x] 7.2 Register ReviewPolicy in AuthServiceProvider
    - Add policy mapping for Review model
    - _Requirements: 6.1_

  - [x] 7.3 Write property test for Ownership Authorization
  ...
  - [x] 7.4 Write property test for Booking Ownership for Creation
...
- [x] 8. Implement Controllers
  ...
  - [x] 8.2 Create ConsultantReviewsController
...
- [x] 9. Configure API Routes
  - [x] 9.1 Add review routes to api.php
